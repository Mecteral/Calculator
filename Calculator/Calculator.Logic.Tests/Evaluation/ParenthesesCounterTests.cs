                ...
                Left =
                    new ParenthesedExpression
                    {
                        Wrapped =
                            new Addition
                            {
                                Left = new ParenthesedExpression {Wrapped = new Constant()},
                                Right = new ParenthesedExpression {Wrapped = new Constant()}
                            }
                    },
                Right =
                    new ParenthesedExpression
                    {
                        Wrapped =
                            new ParenthesedExpression {Wrapped = new ParenthesedExpression {Wrapped = new Constant()}}
                    }
            };
