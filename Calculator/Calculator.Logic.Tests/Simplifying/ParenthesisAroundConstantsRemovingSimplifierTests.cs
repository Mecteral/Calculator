...
{
    [TestFixture]
    public class ParenthesisAroundConstantsRemovingSimplifierTests
    {
        [SetUp]
        public void SetUp()
        {
            mUnderTest= new ParenthesisAroundConstantsRemovingSimplifier();
        }
        ParenthesisAroundConstantsRemovingSimplifier mUnderTest;
