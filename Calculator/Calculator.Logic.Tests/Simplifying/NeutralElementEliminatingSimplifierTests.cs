...
namespace Calculator.Logic.Tests.Simplifying
{
    ...
    public class NeutralElementEliminatingSimplifierTests
    {
        ...
        {
            var input = new Multiplication {Left = new Constant {Value = 1}, Right = new Variable {Variables = "x"}};
        ...
        {
            var input = new Multiplication {Right = new Constant {Value = 1}, Left = new Variable {Variables = "x"}};
            var underTest = new NeutralElementEliminatingSimplifier();
